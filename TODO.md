...
### 2.4 Repository Layer ✅ (Partial)
- [x] Create `UserRepository` (CRUD operations) - In `auth_repository.py`
- [ ] Create `CVRepository` (CRUD + search operations) - *Phase 3*
- [ ] Create `EvaluationRepository` - *Phase 3*
- [ ] Create `EmbeddingRepository` (vector search methods) - *Phase 3*
- [ ] Create `ChatRepository` - *Phase 3*
