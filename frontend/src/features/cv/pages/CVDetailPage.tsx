  ...
  return (
    <Container>
      ...
      <Card className="mb-6 overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 dark:from-blue-800 dark:via-blue-700 dark:to-indigo-800 p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            {/* Left: Candidate Info */}
            <div className="flex items-start gap-3 sm:gap-4 min-w-0 flex-1">
              {/* Avatar with initials */}
              <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2 text-blue-100">
                  ...
                  <span className="text-sm truncate">{cv.filename}</span>
                </div>
            ...
            {/* Right: Score & Status */}
            {cv.evaluation && (
              <div className="flex items-center sm:items-end sm:flex-col gap-2 flex-shrink-0">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl font-bold text-base sm:text-lg ${
                ...
                <div className={`px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium ${
        ...
        <div className="px-4 sm:px-6 py-3 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700">
          {/* Mobile: Stack in grid, Desktop: flex row */}
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap sm:items-center gap-2">
            <button
              onClick={() => setShowSimilar(true)}
              className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 hover:border-blue-300 dark:hover:border-blue-500 transition-colors"
            >
              <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <span className="truncate">Re-evaluate</span>
            </button>
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2 rounded-lg text-xs sm:text-sm font-medium text-blue-600 dark:text-blue-400 bg-white dark:bg-gray-700 border border-blue-200 dark:border-blue-800 hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              ...
              disabled={isSendingNotification}
              className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2 rounded-lg text-xs sm:text-sm font-medium text-green-600 dark:text-green-400 bg-white dark:bg-gray-700 border border-green-200 dark:border-green-800 hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium text-red-600 dark:text-red-400 bg-white dark:bg-gray-700 border border-red-200 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors"
            >
              <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
